...
const SAMPLE_THOUGHTS = [
  {
    id: 1,
    title: "Consciousness",
    description: "The hard problem of why there is subjective experience at all — qualia, awareness, the 'what it is like' of being.",
    tag: "Philosophy"
  },
  {
    id: 2,
    title: "Neuroplasticity",
    description: "The brain's ability to rewire itself through learning, practice, and experience throughout life.",
    tag: "Neuroscience"
  },
  {
    id: 3,
    title: "Flow State",
    description: "Optimal experience where challenge and skill perfectly align — time dissolves, performance peaks.",
    tag: "Psychology"
  },
  {
    id: 4,
    title: "Emergence",
    description: "Complex patterns and behaviours arising from simple rules. The whole becomes greater than the sum of its parts.",
    tag: "Systems"
  },
  {
    id: 5,
    title: "Memory Consolidation",
    description: "How short-term memories are converted to long-term storage during sleep and repetition.",
    tag: "Neuroscience"
  }
];
...
const now = Date.now();
const SEED_THOUGHTS = SAMPLE_THOUGHTS.map((t) => ({
  ...t,
  createdAt: now
}));
const useNeuroStore = create()(
  persist(
    (set, get) => ({
      ...
      deleteThought: (id) => {
        set((s) => ({
          ...
          selectedThoughtId: s.selectedThoughtId === id ? null : s.selectedThoughtId
        }));
      },
    ...
    AlertDialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "font-display text-foreground", children: title }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              onClick: onConfirm,
              className: variant === "destructive" ? "bg-destructive text-destructive-foreground hover:bg-destructive/90 transition-smooth" : "bg-primary text-primary-foreground hover:bg-primary/90 transition-smooth",
...
function ConnectionModal({
  ...
  const connectedIds = new Set(
    connections.filter((c) => c.fromId === fromThoughtId || c.toId === fromThoughtId).map((c) => c.fromId === fromThoughtId ? c.toId : c.fromId)
  );
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "font-display text-foreground flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "w-4 h-4 text-accent" }),
            "Connect Thought"
          ] }),
          fromThought && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground pt-1", children: [
            "Linking from:",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-medium", children: fromThought.title })
          ] })
        ] }),
        availableThoughts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "py-8 text-center text-muted-foreground text-sm",
            "data-ocid": "connection.empty_state",
            children: thoughts.length <= 1 ? "Add more thoughts before creating connections." : "All thoughts are already connected."
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-64 pr-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: availableThoughts.map((thought, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            onClick: () => setSelectedId(selectedId === thought.id ? null : thought.id),
            onKeyDown: (e) => {
            ...
            className: `w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg border transition-smooth text-left ${selectedId === thought.id ? "border-primary/60 bg-primary/10 text-foreground node-glow" : "border-border/40 bg-secondary/30 text-foreground/80 hover:border-primary/30 hover:bg-secondary/50 hover:text-foreground"}`,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `w-2 h-2 rounded-full shrink-0 ${selectedId === thought.id ? "bg-primary node-glow" : "bg-muted-foreground"}`
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm truncate", children: thought.title })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
                thought.tag && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    variant: "outline",
                    className: "text-xs border-border/40 text-muted-foreground",
                    children: thought.tag
                  }
                ),
                selectedId === thought.id && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-primary" })
              ] })
            ]
          },
          thought.id
...
function ThoughtInspectorPanel() {
  const thoughts = useNeuroStore((s) => s.thoughts);
  const connections = useNeuroStore((s) => s.connections);
  ...
  const connectedThoughtIds = connections.filter((c) => c.fromId === thought.id || c.toId === thought.id).map((c) => c.fromId === thought.id ? c.toId : c.fromId);
  const connectedThoughts = thoughts.filter(
    (t) => connectedThoughtIds.includes(t.id)
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 p-4 pb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2.5 h-2.5 rounded-full bg-primary node-glow shrink-0" }),
                thought.tag && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    variant: "outline",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: createdDate })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(ScrollArea, { className: "flex-1 px-4", children: [
            thought.description && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-display text-muted-foreground uppercase tracking-widest mb-2", children: "Description" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-display text-muted-foreground uppercase tracking-widest mb-2", children: [
                "Connections (",
                connectedThoughts.length,
                ")"
              ] }),
              connectedThoughts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "text-sm text-muted-foreground italic",
                  "data-ocid": "inspector.connections_empty_state",
                  children: "No connections yet. Link this thought to others."
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: connectedThoughts.map((ct, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-accent/70 shrink-0" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground/80 truncate group-hover:text-primary transition-smooth", children: ct.title })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3 text-muted-foreground shrink-0 group-hover:text-primary transition-smooth" })
                      ]
                    },
                    ct.id
                  ))
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "bg-border/30" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                variant: "outline",
...
function AddThoughtModal({ open, onOpenChange }) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              tag.trim() && /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: "outline",
...
function Toolbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-6 bg-border/40", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              size: "sm",
              ...
              title: thoughts.length === 0 ? "Add thoughts to explore" : "Jump to random thought",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              disabled: thoughts.length === 0,
              title: thoughts.length === 0 ? "Nothing to clear" : "Clear all thoughts",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AddThoughtModal, { open: addOpen, onOpenChange: setAddOpen }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConfirmDialog,
      {
        open: clearOpen,
...
function GraphEdge({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "line",
    {
      ...
      x2: targetNode.x,
      y2: targetNode.y,
      stroke: isActive ? "oklch(0.65 0.22 190 / 0.9)" : "oklch(0.55 0.18 280 / 0.55)",
      strokeWidth: isActive ? 2 : 1.5,
      className: isActive ? "connection-glow" : "",
      style: {
        filter: isActive ? "drop-shadow(0 0 6px oklch(0.65 0.22 190 / 0.8)) drop-shadow(0 0 12px oklch(0.65 0.22 190 / 0.4))" : "drop-shadow(0 0 3px oklch(0.55 0.18 280 / 0.6)) drop-shadow(0 0 8px oklch(0.55 0.18 280 / 0.25))"
      }
    }
  );
}
...
const MAX_EXTRA = 12;
function getNodeRadius(connectionCount) {
...
function GraphNode({
  ...
  const r2 = getNodeRadius(connectionCount);
  const isActive = isSelected || isHovered;
  const coreColor = isSelected ? "oklch(0.85 0.18 190)" : isHovered ? "oklch(0.78 0.22 190)" : "oklch(0.65 0.22 190)";
  const ringColor = isSelected ? "oklch(0.72 0.22 190 / 0.6)" : isHovered ? "oklch(0.65 0.22 190 / 0.45)" : "oklch(0.55 0.22 190 / 0.2)";
  const glowFilter = isSelected ? `drop-shadow(0 0 ${r2 * 0.9}px oklch(0.65 0.22 190 / 0.85)) drop-shadow(0 0 ${r2 * 2}px oklch(0.55 0.22 190 / 0.45)) drop-shadow(0 0 ${r2 * 3.5}px oklch(0.5 0.22 190 / 0.2))` : isHovered ? `drop-shadow(0 0 ${r2 * 0.7}px oklch(0.65 0.22 190 / 0.7)) drop-shadow(0 0 ${r2 * 1.5}px oklch(0.55 0.22 190 / 0.35))` : `drop-shadow(0 0 ${r2 * 0.5}px oklch(0.55 0.22 190 / 0.5)) drop-shadow(0 0 ${r2}px oklch(0.5 0.22 190 / 0.2))`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "g",
    {
      ...
      children: [
        ...
        node.thought.tag && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "text",
          {
            y: -r2 - 6,
            textAnchor: "middle",
...
function applyRepulsion(nodes, strength = 3e3) {
...
function applyAttraction(connections, nodeMap, strength = 0.04, idealLen = 160) {
...
function applyCenter(nodes, cx2, cy, strength = 0.02) {
  for (const n of nodes) {
    n.vx += (cx2 - n.x) * strength;
    n.vy += (cy - n.y) * strength;
  }
}
function integrate(nodes, alpha, width, height) {
  const damping = 0.78;
  const padding = 60;
  for (const n of nodes) {
    if (n.fx !== null) {
...
function ForceGraph({
  ...
  reactExports.useEffect(() => {
    const tick = () => {
      ...
      if (ns.length === 0 || alphaRef.current < 5e-3) {
        animRef.current = requestAnimationFrame(tick);
        return;
      }
      const nodeMap2 = new Map(ns.map((n) => [n.id, n]));
      applyRepulsion(ns, 3e3);
      applyAttraction(connections, nodeMap2, 0.035, 160);
  ...
  const connectionCountMap = /* @__PURE__ */ new Map();
    ...
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: "bg-grad", cx: "50%", cy: "50%", r: "70%", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.16 0.02 240)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.10 0 0)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("filter", { id: "node-glow-filter", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width, height, fill: "url(#bg-grad)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "pattern",
          {
            id: "grid",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "20", cy: "20", r: "0.8", fill: "oklch(0.35 0.04 240 / 0.4)" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width, height, fill: "url(#grid)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "g",
          {
            transform: `translate(${transform.x}, ${transform.y}) scale(${transform.scale})`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("g", { className: "connection-glow", children: connections.map((conn) => {
                const src = nodeMap.get(conn.fromId);
                const tgt = nodeMap.get(conn.toId);
                if (!src || !tgt) return null;
                const isActive = selectedId === conn.fromId || selectedId === conn.toId || hoveredId === conn.fromId || hoveredId === conn.toId;
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  GraphEdge,
                  {
                    sourceNode: src,
...
function GraphCanvas() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        thoughts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          ForceGraph,
          {
            thoughts,
            connections,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ZoomHint, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Toolbar, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ThoughtInspectorPanel, {})
      ]
    }
  );
}
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(circle, oklch(0.65 0.22 190 / 0.25) 0%, oklch(0.55 0.22 190 / 0.05) 60%, transparent 100%)",
              boxShadow: "0 0 40px oklch(0.65 0.22 190 / 0.3), 0 0 80px oklch(0.55 0.22 190 / 0.12)"
            },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Brain,
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2 px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              className: "text-2xl font-display font-semibold",
              style: { color: "oklch(0.88 0.04 190)" },
              children: "Your neural network awaits"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-body", style: { color: "oklch(0.52 0 0)" }, children: [
            "Add your first thought to begin mapping your mind.",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Every great network starts with a single node."
          ] })
        ] }),
        !prefersReducedMotion && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center pointer-events-none", children: [160, 240, 330].map((size) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              width: size,
              height: size,
              borderColor: `oklch(0.55 0.22 190 / ${0.12 - (size - 160) * 25e-5})`,
              animation: `ping ${2 + size * 5e-3}s cubic-bezier(0, 0, 0.2, 1) infinite`,
              animationDelay: `${(size - 160) * 3e-3}s`,
              opacity: 0.4
            }
          },
          size
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.3 0 0)" }, children: "·" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Maximize2, { size: 12 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Drag to pan" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ZoomOut, { size: 12, style: { display: "none" } })
      ]
    }
  );
}
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient$1, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dark", style: { colorScheme: "dark" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraphCanvas, {}) }) });
}
